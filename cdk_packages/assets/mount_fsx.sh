...
fsx_dns_mount_name=$(eval '/usr/local/bin/aws ssm get-parameters --region '$region' --names /ONT-basecaller/fsx-lustre-dns-mount-name --query '"'"'Parameters[0].Value'"'"' --output text')
mkdir -p /fsx
