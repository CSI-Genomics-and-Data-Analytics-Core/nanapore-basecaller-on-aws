...
class ComputeEnvUpdate(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str, params=None):
        ...
        self.update_compute_environments = lambda_.Function(
            self,
            "Update launch template for AWS Batch",
        ...
        events.Rule(
            self,
            "Update compute environments when new launch template version created",
                ...
                detail={
                    ...
                    "requestParameters": {
                        "CreateLaunchTemplateVersionRequest": {
                            "LaunchTemplateId": [
                                params.base_ami.launch_template.launch_template_id
                            ]
                        }
                    },
                },
